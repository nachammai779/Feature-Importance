...
def get_feature(pdb, features_path, expected_n_channels):
    ...
    avgtrROS_L_L_55 = avgtrROS_512_512_55[:l1,:l1,6:48]
    print(avgtrROS_L_L_55.shape)
    #x_pdnet2 = avgtrROS_L_L_55
    x_pdnet1 = np.concatenate((x_pdnet1[:, :, 0:6], x_pdnet1[:, :, 48:55]), axis = 2)  
    print(x_pdnet1.shape)
    x_pdnet = np.concatenate((x_pdnet1, avgtrROS_L_L_55), axis = 2)  
    print(x_pdnet1.shape)
