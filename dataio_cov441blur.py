...
def get_feature(pdb, features_path, expected_n_channels):
    ...
    avgcov_512_512_441 = np.load('/nvme2tb/nachammai/FeatureExtraction/AVGcov441/250AVG.cov441.npy')
    avgcov_L_L_441 = avgcov_512_512_441[:l1,:l1,:441]
    cov = avgcov_L_L_441
